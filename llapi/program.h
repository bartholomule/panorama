...
namespace panorama
{
  ...
  typedef std::map<std::string, Attribute> TVariableMap;
  ...
  typedef std::map<std::string, TEventCode, std::less<std::string> >  TEventList;
  ...
  public:
    ...
    int addVariable (const std::string& rktNAME, Attribute tREF);

    TEventCode* getEventCode (const std::string& rktNAME);
  };  /* class TProgram */
