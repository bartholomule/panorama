...
int TMaterialWorley::setAttribute (const string& rktNAME, NAttribute nVALUE, EAttribType eTYPE)
{
...
int TMaterialWorley::getAttribute (const string& rktNAME, NAttribute& rnVALUE)
{
...
void TMaterialWorley::getAttributeList (TAttributeList& rtLIST) const
{
