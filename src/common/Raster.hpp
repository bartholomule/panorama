...
#if       !defined(PANORAMA_RASTER_HPP)
#define            PANORAMA_RASTER_HPP
...
namespace panorama
{
	...
	using blocxx::OutOfBoundsException;
	...
	public:
		 ...
		 * @param x The column.
		 * @param y The row.
		 * @throws OutOfBoundsException if either x or y is out of range.
		 */
		 ...
		 * @throws OutOfBoundsException if y is out of range (height).
		 */
		 ...
		 * @throws OutOfBoundsException if any of x1, y1, x2, or y2 are out of range.
	...
	public:
		 ...
		 * @throws OutOfBoundsException if x is out of range
		 ...
		 * @throws OutOfBoundsException if the sizes of the Scanlines (widths) are not
		 *   the same.
		 */
...
#endif /* !defined(PANORAMA_RASTER_HPP) */
