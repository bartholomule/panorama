#include "panorama/graphics/XPMLoader.hpp"
...
namespace panorama
{
	...
	namespace
	{
		typedef GenericRGBColor<unsigned char> ColorType;
		typedef std::pair<String, GenericRGBColor<unsigned char> > NamedColor;
	...
	bool loadXPM(const char* data, MaskedImage<ColorType>& image)
	{
		if( !data || !*data )
		{
			//printf("No data\n");
