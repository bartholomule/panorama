...
*/
#if       !defined(KH_REF_COUNT_OBJECT_H)
#define            KH_REF_COUNT_OBJECT_H
...
/*
  ref_count_object.h -- Kevin Harris
  ...
  reference counting (as in ref_count_pointer.h), but may be able to be used
  for other purposes.
...
public:
  ...
  // like 'resize' are called.  DO NOT CALL THIS UPON ASSIGN UNLESS THE
  // REFERENCE ISN'T TRULY COPIED (ie. only if reinterpreted, resized,
  // manipulated, etc.). 
...
#endif // !defined(KH_REF_COUNT_OBJECT_H)
